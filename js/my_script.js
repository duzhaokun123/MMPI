...
function my_doc_write_question(name, text, text_zh) {
    ...
    document.write("<input type=\"radio\" id=" + name + " name=\"" + name + "\"value=\"T\" required=\"required\" onclick='update_score_side(document.forms.questions)'><label for=" + name + ">是</label>");
    // document.write("<input type=\"radio\" name=" + name + " value=\"T\" >是");
    // document.write("<input type=\"radio\" name=" + name + " value=\"F\">否");
    document.write("<input type=\"radio\" id=Not_" + name + " name=\"" + name + "\"value=\"F\" required=\"required\" onclick='update_score_side(document.forms.questions)'><label for=Not_" + name + ">否</label>");
